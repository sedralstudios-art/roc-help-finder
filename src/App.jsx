...
const UI = {
  en: {
    title: "ROC Help Finder",
    subtitle: "Free help in Rochester. No judgment. No data collected.",
    start: "Find Help Now",
    back: "Back",
  ...
  es: {
    title: "ROC Buscador de Ayuda",
    subtitle: "Ayuda gratis en Rochester. Sin juicio. Sin datos recolectados.",
    start: "Buscar Ayuda",
    back: "Atrás",
...
const PROGRAMS = [
  ...
  // SENIOR
  { id:"ofa", n:"Office for the Aging", c:"seniorSvc", d:"Help for 60+. Meals, transportation, Medicare help, caregiver support.", ph:"585-753-6280", ad:"111 Westfall Rd, Rochester NY 14620", url:"https://www.monroecounty.gov/aging", hr:"M-F 8am-4pm", doc:"Proof of age", tg:["sen"] },
  ...
  { id:"opwdd", n:"OPWDD (Developmental Disabilities)", c:"disabilitySvc", d:"State services: housing, day programs, support.", ph:"866-946-9733", url:"https://opwdd.ny.gov", hr:"M-F 9am-5pm", doc:"Disability documentation", tg:["dis"] },
      ...
      {expanded && (
        <div style={{ marginTop: 12, paddingTop: 12, borderTop: "1px solid #eee" }}>
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginTop: 8 }}>
            ...
            {p.aurl && (
              <a href={p.aurl} target="_blank" rel="noopener noreferrer" style={{
  ...
  return (
    <div ref={containerRef} dir={lang === "ar" ? "rtl" : "ltr"} style={{
      ...
      <div style={{
        ...
        color: "#fff", padding: "20px 20px 16px", position: "relative",
      }}>
        ...
        {/* Step indicator */}
        {currentStepIndex >= 0 && (
          <div role="progressbar" aria-valuenow={currentStepIndex + 1} aria-valuemin={1} aria-valuemax={4} aria-label={stepLabels[currentStepIndex]} style={{ display: "flex", gap: 4, marginTop: 14 }}>
            {stepLabels.map((_, i) => (
              <div
                key={i}
                style={{
          ...
          <div style={{ textAlign: "center", paddingTop: 20 }}>
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 14, padding: "16px 32px", fontSize: 18,
...
export default function RocHelp() {
  return (
    <ErrorBoundary>
      <RocHelpInner />
    </ErrorBoundary>
