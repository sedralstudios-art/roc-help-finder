...
// English with the "translation in progress" banner.
//
// Translation notes:
...
export default {
  ...
  "lifeline-phone-program-fed": {
    ...
    summary:
      "El programa Lifeline ofrece un descuento mensual en el servicio telefónico o de internet para personas de bajos ingresos. Si recibe SNAP, Medicaid, SSI o vive en vivienda pública, califica automáticamente. Muchos proveedores ofrecen planes totalmente gratuitos después del descuento de Lifeline. Solo se permite un beneficio de Lifeline por hogar.",
    yourRights: [
      "Tiene derecho a solicitar Lifeline en línea, por correo o a través de un proveedor participante.",
      "Tiene derecho a elegir su propio proveedor y plan de cualquier proveedor participante de Lifeline en su área.",
      "Tiene derecho a cambiar de proveedor en cualquier momento.",
      "Tiene derecho a solicitar el programa sin costo alguno. Ningún proveedor o agencia legítimo le cobrará una tarifa por solicitar Lifeline.",
      "Si es sobreviviente de violencia doméstica o trata de personas, tiene derecho a recibir apoyo de emergencia de Lifeline por hasta seis meses bajo la Ley Safe Connections. Su privacidad está protegida.",
      "Tiene derecho a recibir el descuento de Lifeline incluso si también recibe otros beneficios públicos. Lifeline no afecta sus beneficios de SNAP, Medicaid u otros.",
    ],
  },

  "monroe-county-dss-overview-ny-mon": {
    title: "Departamento de Servicios Humanos del Condado de Monroe — Dónde Solicitar Beneficios",
    summary:
      "El Departamento de Servicios Humanos del Condado de Monroe gestiona las solicitudes de SNAP, Medicaid, Asistencia Temporal, HEAP y cuidado infantil. Hay dos oficinas en Rochester. Se aceptan solicitudes sin cita de lunes a viernes.",
    yourRights: [
      "Tiene derecho a solicitar beneficios en la oficina de DHS del Condado de Monroe durante el horario laboral sin necesidad de cita.",
      "Tiene derecho a recibir una solicitud el mismo día que visite la oficina.",
      "Tiene derecho a ser evaluado para beneficios de SNAP acelerados el mismo día que presente su solicitud.",
      "Tiene derecho a ser evaluado para asistencia de emergencia el mismo día que presente su solicitud si enfrenta una emergencia.",
      "Tiene derecho a recibir servicios en su idioma preferido. DHS del Condado de Monroe tiene una política de Competencia Limitada en Inglés (LEP).",
      "Tiene derecho a solicitar en línea a través de mybenefits.ny.gov en lugar de visitar la oficina en persona.",
      "Tiene derecho a comunicarse con la línea fuera de horario al (585) 442-1742 o al 2-1-1 para emergencias fuera del horario laboral.",
    ],
  },

  "benefit-overpayment-ny": {
    title: "Sobrepago de Beneficios — Qué Hacer Si la Agencia Dice Que Debe Devolver Dinero",
    summary:
      "Si el Departamento de Servicios Sociales dice que recibió más beneficios de los que le correspondían, podrían intentar cobrarle la diferencia. Esto puede ocurrir incluso si el sobrepago fue un error de la agencia. Tiene derecho a apelar, a solicitar una reducción por dificultades económicas y a negociar un plan de pagos.",
    yourRights: [
      "Tiene derecho a recibir un aviso por escrito que explique el monto del sobrepago, la razón y su derecho a apelar.",
      "Tiene derecho a solicitar una audiencia imparcial dentro de 60 días si no está de acuerdo con la determinación del sobrepago.",
      "Tiene derecho a solicitar que el descuento mensual se reduzca del 10% al 5% de su subsidio mensual si le causa dificultades económicas indebidas.",
      "Tiene derecho a negociar un plan de pagos que pueda pagar si su caso está cerrado.",
      "Tiene derecho a solicitar que se reconsideren sus circunstancias financieras si cambian durante un plan de pagos.",
      "Tiene derecho a impugnar cada sobrepago por separado en una audiencia imparcial.",
      "Tiene derecho a continuar recibiendo sus beneficios actuales durante una audiencia imparcial si solicita la audiencia antes de la fecha efectiva del descuento.",
    ],
  },

  "benefits-denial-appeal-ny": {
    title: "¿Beneficios Negados o Recortados? Cómo Apelar a Través de una Audiencia Imparcial",
    summary:
      "Si sus beneficios públicos son negados, reducidos o cortados, tiene derecho a apelar a través de una audiencia imparcial estatal. Una audiencia imparcial le permite explicarle a un juez por qué cree que la decisión fue incorrecta. En muchos casos, sus beneficios pueden continuar mientras la apelación está pendiente.",
    yourRights: [
      "Tiene derecho a solicitar una audiencia imparcial dentro de 60 días a partir de la fecha del aviso sobre sus beneficios.",
      "Tiene derecho a continuar recibiendo sus beneficios actuales mientras la apelación está pendiente, si solicita la audiencia antes de la fecha efectiva de la reducción o terminación.",
      "Tiene derecho a ver todo su expediente antes de la audiencia y a recibir copias gratuitas de todos los documentos que la agencia presentará.",
      "Tiene derecho a traer un abogado, defensor, pariente, amigo u otro representante que le ayude en la audiencia.",
      "Tiene derecho a presentar evidencia, traer testigos y cuestionar a los testigos de la agencia.",
      "Tiene derecho a un intérprete sin costo si no habla inglés.",
      "Tiene derecho a solicitar un aplazamiento si no puede asistir en la fecha programada.",
      "Tiene derecho a solicitar una audiencia acelerada para casos de Medicaid cuando un retraso pondría en peligro su vida, salud o capacidad para funcionar.",
      "Tiene derecho a recibir una decisión por escrito después de la audiencia.",
    ],
  },

  "benefits-verification-letter-ny": {
    title: "Carta de Verificación de Beneficios — Cómo Probar Que Recibe Beneficios",
    summary:
      "Muchos programas requieren prueba de que recibe beneficios de SNAP, Medicaid, Asistencia Temporal o del Seguro Social. Puede obtener esta prueba en línea, por teléfono o en persona. El proceso depende de cuál beneficio necesite verificar.",
    yourRights: [
      "Tiene derecho a solicitar una carta de verificación de beneficios a la agencia que administra sus beneficios.",
      "Tiene derecho a acceder a la información de su caso y al estado de sus beneficios a través de mybenefits.ny.gov en cualquier momento.",
      "Tiene derecho a recibir una carta de verificación de beneficios del Seguro Social a través de su cuenta my Social Security en ssa.gov.",
      "Tiene derecho a solicitar que su oficina local de DSS proporcione una confirmación por escrito del estado de sus beneficios.",
      "Tiene derecho a recibir copias de avisos y documentos de su expediente.",
    ],
  },

  "childcare-assistance-ny": {
    title: "Asistencia para el Cuidado Infantil — Ayuda para Pagar la Guardería",
    summary:
      "El Programa de Asistencia para el Cuidado Infantil ayuda a las familias a pagar el cuidado de niños para que los padres puedan trabajar, asistir a la escuela o capacitarse para un empleo. Está disponible para familias de ingresos bajos y moderados. Las familias elegibles pagan una pequeña tarifa semanal en una escala móvil. El resto se paga directamente al proveedor de cuidado infantil.",
    yourRights: [
      "Tiene derecho a solicitar asistencia para el cuidado infantil en su Departamento de Servicios Sociales local.",
      "Tiene derecho a elegir su propio proveedor de cuidado infantil, incluyendo a un familiar o amigo que cumpla con los requisitos de proveedor legalmente exento.",
      "Tiene derecho a 12 meses de elegibilidad garantizada una vez aprobado. Su tarifa como padre no cambiará durante ese período.",
      "Tiene derecho a continuar recibiendo asistencia para el cuidado infantil incluso si su hijo cumple 13 años durante el período de elegibilidad de 12 meses.",
      "Tiene derecho a una audiencia imparcial si su solicitud es negada, sus beneficios son reducidos o su caso es cerrado.",
      "Tiene derecho a asistencia para el cuidado infantil mientras se procesa su solicitud si está recibiendo Asistencia Temporal.",
    ],
  },

  "disability-medicaid-ny": {
    title: "Medicaid por Discapacidad — Cobertura Médica para Personas con Discapacidad",
    summary:
      "Las personas con discapacidad, las personas ciegas y los adultos de 65 años o más pueden calificar para Medicaid bajo las reglas Non-MAGI. Estas reglas cuentan tanto el ingreso como los activos, pero Nueva York permite muchas deducciones y exenciones. También existe un programa Medicaid Buy-In para personas con discapacidad que trabajan.",
    yourRights: [
      "Tiene derecho a solicitar Medicaid Non-MAGI en su Departamento de Servicios Sociales local en cualquier momento.",
      "Tiene derecho a que su discapacidad sea evaluada por la Unidad de Revisión de Discapacidad del Estado si no tiene una certificación de discapacidad del SSA.",
      "Tiene derecho a que más de la mitad de sus ingresos ganados no se cuenten al calcular su elegibilidad.",
      "Tiene derecho a conservar su vivienda principal, un vehículo y su propiedad personal sin que cuenten en su contra.",
      "Tiene derecho a usar el programa de reducción de gastos (spend-down) o un Fideicomiso Grupal de Necesidades Suplementarias para calificar si su ingreso está por encima del límite.",
      "Tiene derecho al Medicaid Buy-In para Personas con Discapacidad que Trabajan si es menor de 65 años, tiene una discapacidad y está trabajando.",
      "Tiene derecho a una audiencia imparcial si su solicitud es negada, sus beneficios son reducidos o su cobertura termina.",
      "Tiene 60 días a partir de la fecha de un aviso adverso para solicitar una audiencia imparcial.",
    ],
  },

  "earned-income-tax-credit-ny": {
    title: "Crédito Tributario por Ingreso del Trabajo — Dinero de Vuelta para Familias Trabajadoras",
    summary:
      "El Crédito Tributario por Ingreso del Trabajo (EITC) es un crédito tributario reembolsable para personas que trabajan y ganan ingresos bajos o moderados. Puede recibir dinero de vuelta incluso si no debe impuestos. El Estado de Nueva York añade un crédito adicional equivalente al 30% del monto federal. Debe presentar una declaración de impuestos para recibirlo.",
    yourRights: [
  ...
  "emergency-cash-assistance-ny": {
    title: "Asistencia de Efectivo de Emergencia — Ayuda Única para Renta, Servicios Públicos y Crisis",
    summary:
      "Si enfrenta un desalojo, un corte de servicios públicos o la falta de vivienda, puede calificar para un subsidio único de asistencia de emergencia. No necesita recibir asistencia pública continua para poder solicitar.",
    yourRights: [
      "Tiene derecho a solicitar asistencia de emergencia en su Departamento de Servicios Sociales local incluso si no está recibiendo Asistencia Temporal continua.",
      "Tiene derecho a ser entrevistado y a recibir una decisión sobre su emergencia el mismo día que presente su solicitud.",
      "Tiene derecho a asistencia de emergencia para prevenir un desalojo, un corte de servicios públicos o quedarse sin vivienda.",
      "Tiene derecho a una audiencia imparcial si su solicitud de asistencia de emergencia es negada.",
      "Tiene 60 días a partir de la fecha de una negación para solicitar una audiencia imparcial.",
      "Tiene derecho a continuar recibiendo cualquier beneficio en curso mientras una audiencia imparcial está pendiente.",
    ],
  },

  "fair-hearing-ny": {
    title: "Audiencias Imparciales — Qué Esperar y Cómo Prepararse",
    summary:
      "Una audiencia imparcial es su oportunidad de decirle a un Juez de Derecho Administrativo por qué cree que una decisión sobre sus beneficios fue incorrecta. No necesita un abogado. La audiencia es menos formal que un procedimiento judicial, y la mayoría de las audiencias se realizan por teléfono. La preparación y la evidencia son las claves para un buen resultado.",
    yourRights: [
      "Tiene derecho a revisar todo su expediente en la oficina local de DSS antes de la audiencia y a recibir copias gratuitas de todos los documentos.",
      "Tiene derecho a recibir el paquete de evidencia de DSS al menos dos días hábiles antes de la audiencia.",
      "Tiene derecho a presentar su propia evidencia a OTDA al menos dos días hábiles antes de la audiencia, por fax, correo o a través del portal seguro de carga.",
      "Tiene derecho a traer testigos que puedan apoyar su caso.",
      "Tiene derecho a cuestionar al representante de DSS sobre su testimonio y evidencia.",
      "Tiene derecho a un intérprete sin costo si no habla inglés.",
      "Tiene derecho a solicitar un aplazamiento si no puede asistir en la fecha programada.",
      "Tiene derecho a pedirle al juez que mantenga abierto el expediente si necesita un breve plazo para obtener evidencia adicional.",
      "Tiene derecho a reembolso por transporte, cuidado infantil y otros costos necesarios para asistir a la audiencia.",
      "Tiene derecho a solicitar que la audiencia se reabra si la perdió por causa justificada, dentro de un año de la fecha perdida.",
    ],
  },

  "heap-utility-assistance-ny": {
    title: "HEAP — Ayuda para Pagar la Calefacción, los Servicios Públicos y la Refrigeración",
    summary:
      "El Programa de Asistencia de Energía para el Hogar (HEAP) ayuda a los neoyorquinos elegibles a pagar los costos de calefacción, refrigeración y servicios públicos. Los beneficios de HEAP no tienen que ser devueltos. Más de 1.5 millones de hogares en Nueva York reciben HEAP cada año.",
    yourRights: [
      "Tiene derecho a solicitar los beneficios de HEAP en línea, por teléfono, por correo o en persona en su Departamento de Servicios Sociales local.",
      "Tiene derecho a recibir los beneficios regulares de HEAP incluso si tiene ahorros, acciones u otros recursos.",
      "Tiene derecho a un beneficio aumentado si su hogar incluye a un miembro de 60 años o más, a un menor de 6 años o a una persona con discapacidad permanente.",
      "Tiene derecho a la asistencia de HEAP de Emergencia si le cortaron la calefacción, está programada para ser cortada o se le agotó el combustible.",
      "Tiene derecho a una audiencia imparcial si su solicitud de HEAP es negada.",
      "Tiene derecho a recibir los beneficios de HEAP incluso si su calefacción está incluida en la renta.",
    ],
  },

  "medicaid-ny": {
    title: "Medicaid — Seguro Médico Gratuito en Nueva York",
    summary:
      "Medicaid es un programa de seguro médico gratuito o de bajo costo para personas de bajos ingresos. Nueva York expandió Medicaid para que la mayoría de los adultos menores de 65 años puedan calificar solo por ingresos, sin prueba de ahorros o activos.",
    yourRights: [
      "Tiene derecho a solicitar Medicaid en cualquier momento. No hay un período de inscripción limitado.",
      "Tiene derecho a recibir una decisión dentro de 45 días después de presentar una solicitud completa, o 90 días si la solicitud involucra una determinación de discapacidad.",
      "Tiene derecho a 12 meses de cobertura continua una vez aprobado, incluso si su ingreso cambia temporalmente.",
      "Tiene derecho a elegir a su propio proveedor de atención médica entre cualquier proveedor que acepte Medicaid.",
      "Tiene derecho a una audiencia imparcial si su solicitud es negada, sus beneficios son reducidos o su cobertura termina.",
      "Tiene 60 días a partir de la fecha de un aviso adverso para solicitar una audiencia imparcial.",
      ...
      "Tiene derecho a recibir ayuda con la solicitud y los materiales en su idioma preferido.",
      "Tiene derecho a cobertura de Medicaid de emergencia para condiciones médicas de emergencia sin importar su estatus migratorio.",
    ],
  },

  "medicaid-spend-down-ny": {
    title: "Reducción de Gastos de Medicaid (Spend-Down) — Cobertura Cuando Su Ingreso Está Sobre el Límite",
    summary:
      "Si su ingreso está ligeramente por encima del límite de Medicaid, aún puede calificar a través del Programa de Ingreso Excedente de Medicaid. Este programa le permite usar facturas médicas para reducir su ingreso contable y calificar para la cobertura de Medicaid.",
    yourRights: [
      "Tiene derecho a participar en el programa de spend-down si su ingreso excede el límite de Medicaid pero cumple con todos los demás requisitos de elegibilidad.",
      "Tiene derecho a usar facturas médicas pagadas o sin pagar para cumplir con su monto de spend-down.",
      "Tiene derecho a enviar sus facturas por fax a la oficina de DSS en lugar de entregarlas en persona, especialmente como acomodo razonable por una discapacidad.",
      "Tiene derecho a cobertura retroactiva de Medicaid por hasta tres meses antes del mes en que presentó su solicitud, si tuvo gastos médicos elegibles durante ese tiempo.",
      "Tiene derecho a una audiencia imparcial si su solicitud es negada o si su monto de ingreso excedente se calcula incorrectamente.",
      "Tiene derecho a elegir entre el método de presentación de facturas y el Programa Pay-In.",
    ],
  },

  "medicare-savings-program-ny": {
    title: "Programas de Ahorro de Medicare — Ayuda para Pagar los Costos de Medicare",
    summary:
      "Si tiene Medicare e ingresos limitados, los Programas de Ahorro de Medicare de Nueva York pueden pagar sus primas, deducibles y copagos de Medicare. Nueva York tiene algunas de las reglas de elegibilidad más generosas del país. No hay prueba de activos. Inscribirse también lo califica para Extra Help con los costos de medicamentos recetados.",
    yourRights: [
      "Tiene derecho a solicitar un Programa de Ahorro de Medicare en cualquier momento. No hay un período de inscripción limitado.",
      "Tiene derecho a que su solicitud se decida basándose únicamente en el ingreso. Nueva York no cuenta activos ni recursos para QMB o QI.",
      "Tiene derecho a la inscripción automática en Extra Help para los costos de medicamentos recetados cuando está inscrito en QMB o QI.",
      "Si está inscrito en QMB, tiene derecho a negarse a pagar los copagos y deducibles de Medicare. Los proveedores no pueden facturarle estos montos.",
      "Tiene derecho a una audiencia imparcial si su solicitud es negada.",
      "Tiene derecho a solicitar incluso si su ingreso está cerca del límite. Ciertas exclusiones de ingresos pueden reducir su ingreso contable.",
    ],
  },

  "school-meals-free-reduced-ny": {
    title: "Comidas Escolares Gratuitas — Todos los Estudiantes en Nueva York Reciben Desayuno y Almuerzo Gratis",
    summary:
      "A partir del año escolar 2025-2026, todos los estudiantes en el Estado de Nueva York reciben desayuno y almuerzo gratis en la escuela, sin importar el ingreso familiar. No se necesita una solicitud para recibir las comidas. Esto aplica a todas las escuelas que participan en el Programa Nacional de Almuerzos Escolares.",
    yourRights: [
      "Todo estudiante tiene derecho a recibir desayuno y almuerzo gratis en la escuela cada día escolar, sin importar el ingreso familiar.",
      "Ningún estudiante puede ser identificado como de bajos ingresos, estigmatizado o tratado de manera diferente por recibir comidas gratuitas.",
