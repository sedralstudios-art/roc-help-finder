export const ELECTRIC_FENCE_RULES_NY = {
  ...
  yourRights: {
    en: [
      ...
      "A neighbor has the right to report an electric fence that creates a safety hazard to code enforcement.",
      "Low-energy garden electric fences (deer or rabbit protection) are generally allowed when a proper charger is used and warning signs are posted."
    ]
  },

  legalOptions: {
    en: [
      "Town Law § 300 and § 309 set the division-fence framework; agricultural-district farms get added protection under Agriculture and Markets Law § 305-a.",
      ...
      "Warning signs on an electric fence are required practice and carry weight in any injury case.",
      "Cornell Cooperative Extension of Monroe County at (585) 753-2550 offers guidance on proper agricultural fencing and garden fence setup."
    ]
  },

  example: {
    en: "Dave installed a low-energy electric fence around his vegetable garden in Rush to keep deer out. The fence used a solar-powered charger designed for garden use — the shock was startling but not harmful. He posted small warning signs every 20 feet. A neighbor's child touched it and cried but was not injured. The neighbor complained, but because Dave used proper equipment, posted warnings, and the fence was on his own property, the town found no violation. If Dave had wired the fence to a wall outlet, the outcome could have been very different — civil liability for any injury, and possibly criminal exposure."
  },
