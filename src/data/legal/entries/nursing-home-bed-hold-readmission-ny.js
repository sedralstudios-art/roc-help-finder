export const NURSING_HOME_BED_HOLD_READMISSION_NY = {
  ...
  legalOptions: {
    en: [
      "Long-Term Care Ombudsman at (855) 582-6769 — free advocacy for nursing home residents, resolves bed-hold and readmission disputes.",
      "NYS DOH Centralized Complaint Intake at (888) 201-4563 — formal complaint investigation.",
      "Lifespan of Greater Rochester at (585) 244-8400 — local elder advocacy.",
      "Empire Justice Center Health Law Unit at (585) 454-4060 — legal help for low-income elders.",
      "CMS Transfer/Discharge Hearing: request in writing within 30 days of a transfer/discharge notice.",
      "NY Attorney General Health Care Bureau at (800) 771-7755 — systemic nursing home complaints.",
      "Request the bed-hold notice in writing at admission and keep a copy — essential for later complaints."
    ]
  },
  ...
  counsel: [
    {
      type: "government",
      name: "NY Long-Term Care Ombudsman Program",
      focus: "Nursing home advocacy, bed-hold and readmission disputes",
      qualifier: "Nursing home residents and families, all of NY",
      access: "Phone at (855) 582-6769",
      outcome: "Free mediation, advocacy, and complaint support",
      phone: "",
      url: "https://ltcombudsman.ny.gov",
      verified: true,
      bilingual: true,
      languages: ["es"]
    },
    {
      type: "government",
      name: "NYS DOH Centralized Complaint Intake",
      focus: "Nursing home regulatory complaints, readmission denials",
      qualifier: "Any resident or family member",
      access: "Phone at (888) 201-4563",
      outcome: "State inspection and enforcement action",
      phone: "",
  ...
  tags: [
    ...
    "10 NYCRR 415.3",
    "Medicaid bed-hold",
    "nursing home hospitalization",
    "LTC ombudsman",
    "readmit first available bed",
    "therapeutic leave",
    "nursing home rights"
  ],

  sources: [
    "https://www.ecfr.gov/current/title-42/chapter-IV/subchapter-G/part-483/subpart-B/section-483.15",
    "https://regs.health.ny.gov/content/section-4153-involuntary-discharge-and-transfer-residents"
  ],
