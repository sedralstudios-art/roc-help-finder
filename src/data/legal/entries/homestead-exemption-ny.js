export const HOMESTEAD_EXEMPTION_NY = {
  id: "homestead-exemption-ny",
  category: "consumer",
  tier: "state",
  jurisdiction: "us-ny",
  ...
  whoQualifies: {
    en: [
      "Any homeowner in New York who is being sued or has a judgment against them.",
      "Any homeowner facing a creditor trying to force the sale of their home.",
      "Any homeowner considering bankruptcy who wants to understand how much home equity is protected.",
      "Any homeowner who received notice that a creditor placed a lien on their property."
    ]
  },
  ...
  yourRights: {
    en: [
      ...
      "The exemption covers the homeowner's primary residence only — investment properties and second homes are not protected."
    ]
  },
  ...
  counsel: [
    {
      ...
      focus: "Creditor defense, homestead exemption, judgment defense",
