export const MONROE_COUNTY_DSS_OVERVIEW_NY_MON = {
  ...
  legalOptions: {
    en: [
      "The Monroe County Department of Human Services Financial Assistance Division is located at 691 St. Paul Street, Rochester, NY 14605. This is the primary location for SNAP, Medicaid, and Temporary Assistance applications.",
      "The Westfall Road office is located at 111 Westfall Road, Rochester, NY 14620. This location handles administrative services, family services, and HEAP equipment repair applications.",
      "Both offices are open Monday through Friday, 8:00 a.m. to 4:00 p.m. Walk-in applications are accepted during these hours.",
      "The main phone number is (585) 753-6998. The application line for SNAP and other benefits is (585) 753-6960.",
      ...
      "The child care assistance application line is (585) 753-6316. A child care eligibility screening calculator is available on the Monroe County website at monroecounty.gov/hs-daycare.",
  ...
  counsel: [
    {
      ...
      focus: "Public benefits, applications, denials, fair hearings, housing",
    ...
    },
    {
      ...
      focus: "Public benefits, housing, consumer issues, fair hearings",
  ...
  tags: [
    "Monroe County DSS",
    "DHS Rochester",
    "where to apply benefits",
    "social services Rochester",
    "welfare office Rochester",
    "SNAP office Monroe County",
    "Medicaid office Rochester",
    "Westfall Road",
    "St Paul Street DSS",
    "apply for benefits Rochester",
