export const DOG_LEASH_LAW_OFF_LEASH_NY = {
  id: "dog-leash-law-off-leash-ny",
  category: "family",
  tier: "state",
  jurisdiction: "us-ny",
  authorityType: "state-statute",
  primaryStatute: "NY AGM 122",
  status: "active",
  ...
  example: {
    en: "Brianna walked her Golden Retriever off-leash in a Brighton public park because the dog obeyed voice commands. Brighton Animal Control issued a ticket under Chapter 82 for 150 dollars. Brianna appeared in Brighton Town Court, presented her training records, and argued effective control. The judge reduced the fine to 50 dollars as a first offense warning but made clear the leash rule applies regardless of training. Brianna now uses the off-leash area at Buckland Park where the leash rule is lifted."
  },
  ...
  tags: [
    ...
    "AGM 122",
    "off-leash fine",
    "leash ordinance Rochester",
    "Monroe County dog park",
    "six foot leash NY",
    "voice control dog",
    "Brighton leash law",
    "Greece dog law",
    "dog park Monroe County"
  ],

  sources: [
    "https://www.nysenate.gov/legislation/laws/AGM/122",
