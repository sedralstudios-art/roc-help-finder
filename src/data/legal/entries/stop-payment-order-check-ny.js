export const STOP_PAYMENT_ORDER_CHECK_NY = {
  ...
  whatItMeans: {
    en: "NY Uniform Commercial Code Section 4-403 governs stop payment orders. The rule: a bank customer (the drawer or a person authorized to draw on the account) may order the bank to stop payment on any item payable from the customer's account. The order must describe the item with reasonable certainty, usually by check number, date, amount, and payee. The order must be received in time to give the bank a reasonable opportunity to act on it before payment, certification, or final settlement. Oral vs written: Uniform Commercial Code § 4-403(2) provides that an oral stop payment order is binding for 14 calendar days and can be confirmed in writing within that period, in which case it lasts 6 months. A written order, or written confirmation, lasts 6 months from the date given. After 6 months the order lapses unless renewed in writing. Fees: banks charge a stop payment fee — typically $30 to $35 per order in New York, waived in some situations (lost check, reported fraud). Renewal requires another fee. Bank liability: Uniform Commercial Code § 4-403(3) puts the burden on the customer to establish the fact and amount of loss caused by payment contrary to a valid stop order. If the bank pays after a valid stop, the customer can seek re-credit up to the amount of the loss. The bank is subrogated to the customer's rights against the payee (Uniform Commercial Code § 4-407). Limits on stop orders: some checks cannot be stopped. Cashier's checks, teller's checks, and certified checks are the bank's own obligations and generally cannot be stopped because the bank has already committed to pay. Uniform Commercial Code § 3-411 provides a limited remedy for damages from wrongful dishonor of a cashier's check. An exception under Uniform Commercial Code § 3-312 lets a remitter claim relief on a lost cashier's check after a 90-day waiting period. Post-dated checks: a check dated in the future can be presented early and the bank can pay it. Uniform Commercial Code § 4-401(3) allows the customer to give notice of the post-date to protect against early payment. Electronic payments: ACH debits and electronic checks are governed by NACHA rules and Regulation E for consumer accounts. A consumer can stop preauthorized electronic payments with 3 business days notice under 15 USC 1693e. Reissued checks: stopping a check does not cancel the underlying debt. If the recipient was owed money and the check was the payment, the payer may still owe. The underlying obligation is separate from the check (Uniform Commercial Code § 3-310). Customer duties: a customer should examine bank statements promptly. Under Uniform Commercial Code § 4-406, the customer has a duty to report unauthorized signatures and alterations within a reasonable time (typically 30 days). Failure to report can limit bank liability."
  },

  yourRights: {
    en: [
      "A bank customer has the right to stop payment on any check the customer wrote (Uniform Commercial Code § 4-403).",
      "An oral stop order is binding for 14 calendar days (Uniform Commercial Code § 4-403(2)).",
      "A written stop order lasts 6 months and is renewable in writing.",
      "A bank that pays over a valid stop order is liable for the customer's loss (Uniform Commercial Code § 4-403(3)).",
      "A customer has the right to reasonable fees for a stop order — often $30 to $35.",
      "A customer has the right to protect against premature payment of a post-dated check with notice (Uniform Commercial Code § 4-401(3)).",
      "A consumer has the right to stop preauthorized electronic payments with 3 business days notice (15 USC 1693e).",
      "A customer has the duty to examine statements and report unauthorized items promptly (Uniform Commercial Code § 4-406)."
    ]
  },
