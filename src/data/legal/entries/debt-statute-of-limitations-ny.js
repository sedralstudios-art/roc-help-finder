export const DEBT_STATUTE_OF_LIMITATIONS_NY = {
  id: "debt-statute-of-limitations-ny",
  category: "consumer",
  tier: "state",
  jurisdiction: "us-ny",
  ...
  whoQualifies: {
    en: [
      "Any person being contacted about an old debt.",
      "Any person being sued for a debt and wondering whether the statute of limitations has expired.",
      "Any person considering making a payment on an old debt and wanting to understand the consequences.",
      "The statute of limitations applies to credit card debt, medical debt, personal loans, and other consumer obligations."
    ]
  },
  ...
  legalOptions: {
    en: [
      ...
      "If a debt collector files a lawsuit on a time-barred debt without disclosing the expiration, file an FDCPA complaint with the CFPB at consumerfinance.gov/complaint."
    ]
  },
  ...
  counsel: [
    {
      ...
      focus: "Debt defense, statute of limitations, collection harassment",
