export const SNAP_AFTER_CONVICTION_NY = {
  ...
  counsel: [
    {
      ...
      focus: "Re-entry, criminal record barriers, public benefits, employment, housing",
    ...
    },
    {
      ...
      focus: "Public benefits, reentry, fair hearings",
    ...
    },
    {
      ...
      focus: "Benefits advocacy, re-entry, systemic issues",
  ...
  tags: [
    "felony SNAP",
    "food stamps after prison",
    "criminal record benefits",
    "reentry benefits",
    "drug conviction food stamps",
    "benefits after jail",
    "can I get SNAP with a felony",
    "food help after incarceration",
    "benefits after conviction",
    "released from prison help",
    "ex-offender benefits",
