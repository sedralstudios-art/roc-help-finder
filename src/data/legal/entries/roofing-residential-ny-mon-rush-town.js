// LGLW6-D_roofing-residential-ny-mon-rush-town_01.js
...
export const entry = {
  ...
  summary: {
    en: "The Town of Rush explicitly states that ordinary repairs replacing existing materials with new materials of like class and kind — including minor roof repairs — do not require a building permit. However, structural changes to a building do require a permit. For a full roof replacement, contact the Building Department at [number being verified] to confirm whether the scope triggers the structural-change requirement."
  },
