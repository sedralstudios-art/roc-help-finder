// LGLW6-D_hvac-residential-ny-mon-hamlin-town_01.js

export const entry = {
  id: "hvac-residential-ny-mon-hamlin-town",
  category: "trades",
  tier: "town",
  ...
  legalOptions: {
    en: [
      "Town of Hamlin Building Department handles HVAC permits and inspections",
  ...
  counsel: [{
    ...
    qualifier: "Open to residents and contractors working in Town of Hamlin",
    access: "Phone",
  ...
  relatedIds: ["hvac-residential-ny", "plumbing-residential-ny-mon-hamlin-town", "electrical-residential-ny-mon-hamlin-town"],
  relatedHelpResources: [],
  tags: ["trades", "HVAC", "furnace", "heat pump", "hamlin", "monroe county", "town ordinance", "energy code", "gas line"],
