// LGLW6-D_hvac-residential-ny-mon-parma-town_01.js

export const entry = {
  id: "hvac-residential-ny-mon-parma-town",
  category: "trades",
  tier: "town",
  ...
  title: { en: "HVAC work in the Town of Parma: what the town requires" },

  summary: {
    en: "Town of Parma does not license HVAC contractors. Gas line work for a new furnace still needs a licensed plumber — the gas pipe is plumbing work. Town staff do HVAC inspections directly (no third-party agencies). The state Energy Code (2025) applies to all permits filed after December 31, 2025."
  },
  ...
  legalOptions: {
    en: [
      "Town of Parma Building Department handles HVAC permits and inspections",
  ...
  relatedIds: ["hvac-residential-ny", "plumbing-residential-ny-mon-parma-town", "electrical-residential-ny-mon-parma-town"],
  relatedHelpResources: [],
  tags: ["trades", "HVAC", "furnace", "heat pump", "parma", "monroe county", "town ordinance", "energy code", "gas line"],
