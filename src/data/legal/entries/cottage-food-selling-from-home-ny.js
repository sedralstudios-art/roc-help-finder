export const COTTAGE_FOOD_SELLING_FROM_HOME_NY = {
  id: "cottage-food-selling-from-home-ny",
  category: "consumer",
  tier: "state",
  jurisdiction: "us-ny",
  ...
  whoQualifies: {
    en: [
      "Any person who wants to sell homemade baked goods, jams, jellies, candy, or other shelf-stable food.",
      "Any person who sells at farmers markets, roadside stands, craft fairs, or directly from home.",
      "Any person who wants to sell food online for local pickup or delivery within New York."
    ]
  },
  ...
  yourRights: {
    en: [
      ...
      "If a complaint is filed, the NYS Department of Agriculture and Markets can investigate, but routine inspections are not required."
    ]
  },

  legalOptions: {
    en: [
      "NYS Department of Agriculture and Markets — Food Safety at (518) 457-4492 can answer questions about what foods qualify.",
  ...
  counsel: [
    {
      type: "government",
      name: "NYS Department of Agriculture and Markets — Food Safety Division",
      focus: "Cottage food rules, food processing licenses, labeling requirements",
      qualifier: "Any NYS resident",
      access: "Phone at (518) 457-4492",
      outcome: "Guidance on what qualifies as cottage food, labeling rules",
      phone: "(518) 457-4492",
      url: "https://agriculture.ny.gov/food-safety",
      verified: true,
      bilingual: false,
      languages: []
    },
    {
      ...
      focus: "Food safety training, cottage food guidance, small business support",
      qualifier: "Monroe County residents",
      access: "Phone at (585) 753-2550",
      outcome: "Training, guidance, referrals",
      phone: "(585) 753-2550",
  ...
  tags: [
    ...
    "home kitchen food",
    "food license",
    "homemade food selling",
    "cottage food law New York",
    "sell cookies from home",
    "sell baked goods",
    "home processor"
  ],
