export const SECURITY_DEPOSIT_NY = {
  ...
  whoQualifies: {
    en: [
      ...
      "A tenant in a NYC rent-controlled unit — different rules. Rent control is the older NYC system (most rent-controlled tenancies started before 1971) and is run by NY State's Division of Housing and Community Renewal (DHCR), not by the security-deposit law in this entry.",
