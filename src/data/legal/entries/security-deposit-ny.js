export const SECURITY_DEPOSIT_NY = {
  ...
  // rewritten to plain-English non-directive standard. R1–R6 expert review
  // complete (see src/data/legal/anchor-reviews/security-deposit-ny.md);
  // reviewTier intentionally not set until attorney sign-off.
  isAnchor: true,
  anchorSource: {
    url: "https://www.nysenate.gov/legislation/laws/GOB/7-108",
    hash: "77bff025a6c72b0148eb8eaf89dffa37e9d68d22a54715f514d20db4d8354aaf",
    lastFetched: "2026-05-02"
  },
  lastFormallyReviewed: "2026-05-01",
  formallyReviewedBy: "Anthony DiMarzo + WebSearch + R1–R6 expert review (2026-05-01). Provisional, pending attorney sign-off. Round-by-round detail: src/data/legal/anchor-reviews/security-deposit-ny.md.",
  pendingLegislation: ["A8078"],
  ...
  whoQualifies: {
    en: [
      ...
      "A tenant in a rent-stabilized unit — covered by a parallel NY law (General Obligations Law § 7-107). As of November 15, 2025, that law was changed to give rent-stabilized tenants the same protections (one-month cap, 14-day return, walk-throughs, forfeiture, extra penalty for willful violations).",
      "NOT this entry: a tenant in a NYC rent-controlled unit. The cap, 14-day rule, walk-throughs, forfeiture, and extra penalty in this entry do not apply. Rent-controlled tenancies (most started before July 1, 1971) are governed by the older NYC rent-control rules run by NY's Division of Housing and Community Renewal (DHCR). The interest rule (§ 7-103) and the building-sale transfer rule (§ 7-105) still apply.",
  ...
  legalOptions: {
    en: [
      ...
      "Building-sale protection (General Obligations Law § 7-105 — separate from § 7-108): when a rental building is sold, the former landlord has five days to either transfer all security deposits to the new owner or return them to tenants, and must notify tenants by registered or certified mail of the new owner's name and address.",
      "LawHelpNY at lawhelpny.org — statewide referral tool. Looks up free civil legal help by county, including security-deposit help outside the Rochester / LawNY service area.",
      "For NYC tenants: Housing Court Answers at housingcourtanswers.org or (212) 962-4795 for help navigating NYC Housing Court; Legal Aid Society (NYC) at legalaidnyc.org or (212) 577-3300 for income-eligible tenants."
    ]
  },
