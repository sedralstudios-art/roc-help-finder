export const SECURITY_DEPOSIT_NY = {
  ...
  formallyReviewedBy: "Anthony DiMarzo + WebSearch + R1–R4 expert review (2026-05-01). Provisional, pending attorney sign-off. Round-by-round detail: src/data/legal/anchor-reviews/security-deposit-ny.md.",
