export const SECURITY_DEPOSIT_NY = {
  ...
  whoQualifies: {
    en: [
      ...
      "A tenant in a NYC rent-controlled unit — covered by section 7-108 (the law in this entry), AND ALSO covered by a separate older NYC rent-control system run by NY State's Division of Housing and Community Renewal (DHCR). Rent control is the older system (most rent-controlled tenancies started before 1971) and adds protections on top of section 7-108 — it does not replace it.",
