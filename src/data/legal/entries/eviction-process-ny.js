export const EVICTION_PROCESS_NY = {
  ...
  yourRights: {
    en: [
      ...
      "A tenant in a nonpayment case has the right to stop the eviction by paying the full rent owed at any time before the warrant is executed (RPAPL § 749(3)) — months past judgment in a contested case.",
      ...
      "A tenant statewide has the right to stop the warrant in a nonpayment case by depositing the rent owed plus interest and costs into court, or by posting a bond, at any time before the warrant is executed (RPAPL § 751(1)).",
  ...
  legalOptions: {
    en: [
      ...
      "Empire Justice Center at (585) 454-4060 — statewide impact litigation and policy advocacy on housing issues. Not a frontline eviction-defense provider; tenants needing direct representation should start with Legal Aid Society of Rochester, LawNY, or JustCause.",
      ...
      "Monroe County Bar Association Lawyer Referral Service at monroe.community.lawyer (online intake only, 3 business days, $45 referral fee + free half-hour consultation with the matched attorney) — NOT for emergency or same-week eviction help."
    ]
  },

  example: {
    en: "James (a hypothetical Rochester tenant) rents an apartment in a building owned by a landlord who owns three other rental buildings in the city. The landlord sent James a 30-day notice saying the tenancy would end so the landlord could renovate. James had lived there 18 months, so Real Property Law § 226-c actually required 60 days' notice, not 30. He contacted Legal Aid Society of Rochester. A lawyer attended the Rochester City Court hearing, argued the notice was defective, and confirmed that James was covered by Good Cause Eviction under Rochester's adoption — the small-landlord exemption (owners of a single property) did not apply because the landlord owned multiple properties, and the owner-occupied buildings of ten units or fewer exemption did not apply because the landlord did not live in the building. With Good Cause coverage confirmed, the renovation theory required a statutory reason the landlord had not pleaded. The court dismissed the petition. James kept his apartment and the landlord had to start over with a proper notice if a valid reason existed."
  },
  ...
  counsel: [
    ...
    },
    {
      ...
      qualifier: "Statewide; impact case selection; for individual eviction defense, start with Legal Aid Society of Rochester, LawNY, or JustCause",
      access: "Voicemail callback (voicemails are checked daily)",
