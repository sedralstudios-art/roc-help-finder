export const EVICTION_PROCESS_NY = {
  ...
  yourRights: {
    en: [
      ...
      "A tenant has the right to appear in court, raise defenses, and demand a trial (RPAPL § 745). Common defenses include habitability breaches, retaliation, defective notice, and payment of the rent before judgment.",
      ...
      "A tenant outside NYC has the right to ask the court for a discretionary stay of the warrant by paying rent or putting up money as security (RPAPL § 751).",
      "A tenant has the right to seek treble (3×) damages from a landlord who evicts by force, lockout, or utility shutoff without a court order (RPAPL § 853). Attorney fees are not awarded under § 853 itself but may be available under RPL § 234 when the lease has a one-way fee clause."
    ]
  },
