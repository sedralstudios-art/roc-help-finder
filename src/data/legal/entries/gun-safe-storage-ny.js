export const GUN_SAFE_STORAGE_NY = {
  id: "gun-safe-storage-ny",
  category: "criminal",
  tier: "state",
  jurisdiction: "us-ny",
  authorityType: "state-statute",
  primaryStatute: "NY PEN 265.45",
  status: "active",

  title: { en: "Gun Safe Storage Laws — What New York Requires" },

  summary: {
    en: "New York law requires gun owners to safely store firearms to prevent access by children and other unauthorized people. A gun owner who fails to store a weapon properly can face criminal charges, especially if a child gains access and someone is hurt."
  },
  ...
  yourRights: {
    en: [
      "A gun owner has the right to possess firearms in their home as long as they comply with safe storage and licensing requirements.",
      "A gun owner has the right to use a gun lock, a locked safe, or a locked container to meet the safe storage requirement.",
      "A person charged with unsafe storage has the right to an attorney and a trial.",
      "A gun owner has the right to transport a firearm to and from a range or hunting area in compliance with transportation laws.",
      "A person who holds a valid pistol permit has the right to possess handguns listed on the permit.",
      "A gun owner who is unsure about storage requirements can contact the NYS Police for guidance."
    ]
  },
  ...
  legalOptions: {
    en: [
      ...
      "The NYS Police Pistol Permit unit handles handgun licensing questions and can be reached through the local county clerk.",
      "Free gun locks are also available through Project ChildSafe at projectchildsafe.org."
    ]
  },

  example: {
    en: "After New York's safe storage law took effect, Tom realized his hunting rifles were stored in an unlocked closet. His two children, ages 10 and 13, could easily access them. Tom purchased a locking gun cabinet for $150 and stored all firearms inside it. He also got free trigger locks from the Monroe County Sheriff's Office as an extra layer of safety. By storing the guns locked and out of reach, Tom was in compliance with Penal Law Section 265.45."
  },
  ...
  counsel: [
    {
      ...
      focus: "Gun safety, free gun locks, firearm regulations",
