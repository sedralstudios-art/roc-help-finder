export const BOAT_OPERATOR_SAFETY_CERTIFICATE_NY = {
  id: "boat-operator-safety-certificate-ny",
  category: "vehicle",
  tier: "state",
  jurisdiction: "us-ny",
  ...
  legalOptions: {
    en: [
      "NYS Parks Office of Boating Safety at (518) 474-2117 for statewide boating courses and certificate questions.",
      "BoatUS Foundation online course at (800) 336-2628 offers self-paced approved course.",
      "US Coast Guard Auxiliary Rochester Flotilla at (585) 255-1144 for free courses.",
      "US Power Squadrons Monroe County for member courses.",
      "NYS DEC at (518) 402-8888 for bodies-of-water enforcement questions.",
      "For a BWI citation, Monroe County Public Defender at (585) 753-4210 or private criminal defense attorneys."
    ]
  },

  example: {
    en: "Eric grew up boating on Canandaigua Lake. When Brianna's Law expanded to cover all operators in 2025, Eric needed a certificate. He took the 8-hour in-person course through the US Coast Guard Auxiliary Rochester Flotilla free of charge on a Saturday. He received his lifetime certificate the same day. He carries a plastic card in his wallet and a digital version on his phone. His certificate works for any boat on any NY water, and he can use it to rent boats at Finger Lakes marinas."
  },

  counsel: [
    {
      type: "government",
      name: "NYS Parks Office of Boating Safety",
      focus: "Boating safety course certification, course listing, complaint handling",
      qualifier: "Any NY boat operator",
      access: "Phone, website course locator",
      outcome: "Course information, certificate verification",
      phone: "(518) 474-2117",
    ...
    {
      type: "nonprofit",
      name: "US Coast Guard Auxiliary Rochester Flotilla",
      focus: "Free boating safety courses, vessel safety exams",
      qualifier: "Any Monroe County boater",
      access: "Phone, scheduled classes",
      outcome: "Free 8-hour course and lifetime certificate",
      phone: "(585) 255-1144",
      url: "https://wow.uscgaux.info",
      verified: true,
      bilingual: false,
      languages: []
    }
  ...
  relatedIds: [
    ...
    "moped-limited-use-motorcycle-ny"
  ],
