export const LICENSE_SUSPENSION_NY = {
  ...
  yourRights: {
    en: [
      ...
      "A NY driver has the right to a hearing before a revocation under Vehicle and Traffic Law § 510, with limited exceptions for mandatory revocations.",
      ...
      "A driver suspended after a DWI or chemical-test refusal has the right to apply for a conditional license after 30 days by enrolling in the Impaired Driver Program under Vehicle and Traffic Law § 1196.",
      ...
      "A driver charged with Aggravated Unlicensed Operation under Vehicle and Traffic Law § 511 has the right to a court-appointed lawyer at the first court appearance if unable to afford private counsel.",
  ...
  legalOptions: {
    en: [
      ...
      "For insurance-lapse suspensions: the driver's insurer files an SR-22 certificate with the DMV, and the Vehicle and Traffic Law § 318 civil penalty is paid before reinstatement.",
      "Monroe County Public Defender at (585) 753-4210 — represents indigent defendants on Aggravated Unlicensed Operation (AUO) charges under Vehicle and Traffic Law § 511.",
  ...
  counsel: [
    ...
    },
    {
      ...
      focus: "Aggravated Unlicensed Operation (AUO) defense under Vehicle and Traffic Law § 511",
