export const BACKGROUND_CHECK_RIGHTS_NY = {
  ...
  whatItMeans: {
    en: "Correction Law Article 23-A requires all employers and licensing agencies in New York to follow a specific analysis before denying employment or a license based on a criminal conviction. The employer must consider: the public policy of encouraging employment of people with records, the specific duties of the job, the nature and seriousness of the offense, how long ago it occurred, the person's age at the time, any evidence of rehabilitation, and the employer's legitimate interest in protecting people and property. The employer cannot use a blanket policy of 'no criminal records.' Under Article 23-A, a denial must be based on a direct relationship between the offense and the job, or an unreasonable risk to people or property. Sealed records (under CPL 160.50, 160.55, or the Clean Slate Act) cannot appear on background checks and employers cannot ask about them. If a sealed case does appear, the person can challenge the background check company. Under the Fair Credit Reporting Act, background check companies must follow accuracy and dispute procedures."
  },
