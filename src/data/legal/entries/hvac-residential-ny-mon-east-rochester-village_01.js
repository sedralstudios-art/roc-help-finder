// LGLW6-D_hvac-residential-ny-mon-east-rochester-village_01.js

export const entry = {
  id: "hvac-residential-ny-mon-east-rochester-village",
  category: "trades",
  tier: "village",
  jurisdiction: "us-ny-monroe-east-rochester-village",
  status: "active",

  title: { en: "HVAC work in the East Rochester: what the village requires" },

  summary: {
    en: "East Rochester does not license HVAC contractors. Gas line work for a new furnace still needs a licensed plumber — the gas pipe is plumbing work. Town staff do HVAC inspections directly (no third-party agencies). The state Energy Code (2025) applies to all permits filed after December 31, 2025."
  },
  ...
  legalOptions: {
    en: [
      "East Rochester Building Department handles HVAC permits and inspections",
  ...
  relatedIds: ["hvac-residential-ny", "plumbing-residential-ny-mon-east-rochester-village", "electrical-residential-ny-mon-east-rochester-village"],
  relatedHelpResources: [],
  tags: ["trades", "HVAC", "furnace", "heat pump", "east-rochester", "monroe county", "village ordinance", "energy code", "gas line"],
