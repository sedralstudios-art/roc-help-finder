export const SECTION_8_HOUSING_VOUCHER_NY = {
  ...
  counsel: [
    {
      ...
      focus: "Housing, Section 8 terminations, subsidized housing, landlord disputes, fair housing",
      qualifier: "Low income residents in 14 Western NY counties including Monroe",
      access: "Phone intake at (585) 325-2520; Fair Housing line at (866) 671-FAIR",
    ...
    },
    {
      ...
      focus: "Housing, eviction defense, voucher issues, fair hearings",
    ...
    },
    {
      ...
      focus: "Housing, fair housing, civil rights, systemic advocacy",
  ...
  tags: [
    ...
    "voucher denied",
    "landlord won't accept voucher",
    "affordable housing"
  ],

  sources: [
    "https://hcr.ny.gov/hcv",
