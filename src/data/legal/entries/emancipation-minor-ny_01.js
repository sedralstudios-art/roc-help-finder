export const EMANCIPATION_MINOR_NY = {
  ...
  legalOptions: {
    en: [
      ...
      "Foster youth approaching age 21 can access transitional services through the Foster Care Independence Act. Monroe County DSS can be reached at (585) 753-6010.",
