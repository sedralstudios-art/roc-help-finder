export const EMERGENCY_RENTAL_ASSISTANCE_PROGRAM_NY = {
  ...
  legalOptions: {
    en: [
      ...
      "Monroe County Department of Human Services at (585) 753-6998 for local application help.",
