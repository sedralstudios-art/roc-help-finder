export const PHARMACIST_EMERGENCY_REFILL_NY = {
  ...
  legalOptions: {
    en: [
      "Any NY licensed pharmacist (CVS, Walgreens, Rite Aid, Wegmans, independent, hospital) can issue an emergency refill under Education Law § 6810.",
  ...
  example: {
    en: "Omar ran out of his blood pressure medication on a Saturday night when his doctor office was closed. He had one pill bottle but no refills left. He called the CVS on Mt. Hope Avenue, brought the empty bottle, and asked for an emergency refill under Education Law § 6810. The pharmacist verified Omar had been filling the medication monthly for two years, dispensed a 30-day emergency supply, and billed his insurance at the normal 10 dollar copay. The pharmacist also faxed a note to Omar's primary care doctor Monday morning. Omar scheduled a follow-up to get a fresh prescription."
  },
