export const WRONGFUL_TERMINATION_NY = {
  ...
  whoQualifies: {
    en: [
      ...
      "A NY worker at an employer of any size — the NY Human Rights Law 4-employee threshold was eliminated effective Feb 8, 2020 and NYSHRL now applies to all employers regardless of size.",
