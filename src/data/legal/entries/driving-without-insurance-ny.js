export const DRIVING_WITHOUT_INSURANCE_NY = {
  ...
  whatItMeans: {
    en: "Under Vehicle and Traffic Law § 319, every motor vehicle registered in New York must have liability insurance. The minimum coverage is: $25,000/$50,000 bodily injury, $10,000 property damage, $50,000 no-fault (PIP), and $25,000/$50,000 uninsured motorist. When an insurance policy is cancelled or lapses, the insurer notifies the DMV electronically. The DMV sends the vehicle owner a notice and suspends the registration if insurance is not restored. Penalties for driving without insurance (VTL § 319): first offense — fine of $150-$1,500, license suspension for up to 1 year, registration revocation, and a civil penalty of $750. Subsequent offense within 6 months — fine of $300-$1,500, suspension up to 1 year, and civil penalty of $750. The vehicle can also be seized and impounded. If the driver is involved in an accident while uninsured, they are personally liable for all damages — and their license and registration are revoked until all judgments are satisfied. The DMV requires the driver to file an SR-22 (proof of financial responsibility) for 3 years after a lapse, which increases insurance costs. If the lapse was brief and the owner can show continuous coverage was restored quickly, the civil penalty may be reduced. Voluntary plate surrender is the cleanest way to avoid penalties when a vehicle will not be driven for an extended period. Surrendering the plates to the DMV before insurance is cancelled tells the system the vehicle is off the road and stops the lapse penalty clock from running. Plates can be surrendered online for free or at a DMV office, and re-registration when the vehicle is needed again is straightforward. Hardship licenses are not generally available for license suspensions stemming from insurance lapses; they are available for some DWI suspensions and for medical hardship situations. NY's Auto Insurance Plan (NYAIP) is the assigned-risk pool for drivers who cannot obtain coverage through the standard market — typically because of a poor driving record, a recent lapse, or a vehicle classification that standard insurers will not cover. NYAIP coverage is more expensive but cannot be denied to a NY-licensed driver who applies."
  },
