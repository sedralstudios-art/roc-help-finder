// LGLW6-D_hvac-residential-ny-mon-rush-town_01.js

export const entry = {
  id: "hvac-residential-ny-mon-rush-town",
  category: "trades",
  tier: "town",
  ...
  legalOptions: {
    en: [
      "Town of Rush Building Department handles HVAC permits and inspections",
  ...
  counsel: [{
    ...
    qualifier: "Open to residents and contractors working in Town of Rush",
    access: "Phone",
  ...
  relatedIds: ["hvac-residential-ny", "plumbing-residential-ny-mon-rush-town", "electrical-residential-ny-mon-rush-town"],
  relatedHelpResources: [],
  tags: ["trades", "HVAC", "furnace", "heat pump", "rush", "monroe county", "town ordinance", "energy code", "gas line"],
