...
export const entry = {
  ...
  legalOptions: {
    en: [
      "Town of Mendon Building Department handles HVAC permits and inspections",
  ...
  counsel: [{
    ...
    qualifier: "Open to residents and contractors working in Town of Mendon",
    access: "Phone",
  ...
  relatedIds: ["hvac-residential-ny", "plumbing-residential-ny-mon-mendon-town", "electrical-residential-ny-mon-mendon-town"],
  relatedHelpResources: [],
  tags: ["trades", "HVAC", "furnace", "heat pump", "mendon", "monroe county", "town ordinance", "energy code", "gas line"],
