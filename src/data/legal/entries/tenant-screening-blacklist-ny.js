export const TENANT_SCREENING_BLACKLIST_NY = {
  ...
  yourRights: {
    en: [
      ...
      "A violation of RPL 227-f carries a civil penalty of $500 to $1,000 plus actual damages."
    ]
  },
  ...
  legalOptions: {
    en: [
      ...
      "If a denial of housing cites prior housing court history, a complaint can be filed with the NY Attorney General at (800) 771-7755 under RPL 227-f.",
  ...
  example: {
    en: "A tenant in Rochester was taken to housing court by a previous landlord over a rent dispute. The case was dismissed after the tenant proved the rent was paid. Two years later, she applies for a new apartment and is denied. She requests the screening report and finds the dismissed case listed as an 'eviction filing.' She files a complaint with the NY Attorney General under RPL 227-f, which prohibits denials based on prior housing court history. The landlord agrees to reverse the denial and pays a $500 civil penalty. She also disputes the screening report's framing of the dismissed case under the FCRA. She reapplies and is approved."
  },
