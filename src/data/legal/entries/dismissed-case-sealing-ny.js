export const DISMISSED_CASE_SEALING_NY = {
  ...
  title: { en: "A Dismissed Case Still Showing on a Background Check in New York — Criminal Procedure Law § 160.50" },
  ...
  legalOptions: {
    en: [
      ...
      "If the clerk cannot fix it, a short motion to the judge can be filed. There is no filing fee for a Criminal Procedure Law § 160.50 motion. Templates are posted at nycourts.gov.",
