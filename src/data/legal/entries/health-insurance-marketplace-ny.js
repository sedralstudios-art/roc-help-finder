export const HEALTH_INSURANCE_MARKETPLACE_NY = {
  ...
  whatItMeans: {
    en: "NY State of Health (nystateofhealth.ny.gov) is the official marketplace where New Yorkers can compare and buy health insurance plans. Plans are organized into metal tiers — Bronze, Silver, Gold, and Platinum — based on how costs are shared between the plan and the patient. Bronze plans have the lowest monthly cost but highest out-of-pocket costs. Platinum plans cost more per month but cover more when care is needed. Many people qualify for financial help. The Essential Plan is a low-cost option for people who earn too much for Medicaid but not enough for a regular plan — premiums are $0 to $20 per month with low copays. For people with higher incomes, tax credits can reduce the monthly premium for a Qualified Health Plan. Open enrollment is typically November through January. Outside of that window, a qualifying life event (losing other coverage, getting married, having a baby, moving) allows special enrollment within 60 days. Medicaid and Child Health Plus have no enrollment deadline — applications are accepted year-round. Income definitions matter for marketplace subsidies. NY State of Health uses Modified Adjusted Gross Income (MAGI), which is most household income from the federal tax return plus untaxed Social Security and a few other items. MAGI is calculated for the entire household, not individuals — a married couple is assessed together, and dependents on the tax return are included. Updating income mid-year is important: if income rises significantly, the marketplace recalculates subsidies, and the enrollee may owe back the excess subsidy at tax time if not adjusted. The opposite is also true — falling income mid-year qualifies for higher subsidies that should be claimed promptly. Special enrollment qualifying events have specific deadlines and documentation requirements. Loss of coverage requires proof of the prior plan and the termination date; marriage requires the marriage certificate. Missing the 60-day window means waiting until the next open enrollment period unless another qualifying event occurs. Plan changes outside open enrollment are generally not allowed even after enrollment, except for specific qualifying events; the plan a person enrolls in is locked in for the year."
  },
