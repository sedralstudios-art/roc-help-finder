export const WRONGFUL_TOW_VEHICLE_NY = {
  id: "wrongful-tow-vehicle-ny",
  category: "vehicle",
  tier: "state",
  jurisdiction: "us-ny",
  ...
  whoQualifies: {
    en: [
      "A NY vehicle owner whose car was towed from a parking lot with fewer than the required signs under General Business Law § 399-v(2).",
  ...
  yourRights: {
    en: [
      ...
      "A NY vehicle owner has the right to stricter local towing rules when a municipality has adopted them — General Business Law § 399-v(7) preserves local protections."
    ]
  },
  ...
  counsel: [
    {
      ...
      focus: "Private-tow complaints under General Business Law § 399-v outside NYC",
    ...
    },
    {
      ...
      focus: "Pattern predatory towing, kickback violations under General Business Law § 399-v(4)",
      qualifier: "Any NY vehicle owner",
      access: "Phone, online complaint",
