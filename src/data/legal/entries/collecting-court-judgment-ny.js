export const COLLECTING_COURT_JUDGMENT_NY = {
  ...
  yourRights: {
    en: [
      ...
      "A judgment creditor has the right to 9% annual interest on the unpaid amount.",
