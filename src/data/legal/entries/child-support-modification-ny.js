export const CHILD_SUPPORT_MODIFICATION_NY = {
  ...
  whatItMeans: {
    en: "A NY child support modification is handled under Family Court Act § 451. The statute gives the court continuing jurisdiction over a support order — meaning the same court that issued the order can change the amount up or down as circumstances change. The change does not happen on its own. A parent has to file a written petition. Until the court signs a new order, the old order stays in effect, and missed payments become arrears that can be enforced. Family Court Act § 451(1) has a strict rule on arrears — a modification cannot reduce or cancel arrears that accrued before the modification petition was filed, except for arrears where the party shows good cause for not filing earlier. So filing promptly after a change matters. A parent who loses a job and waits six months before filing will still owe the full original amount for those six months. Family Court Act § 451(3) lists the grounds. The first, in § 451(3)(a), is a 'substantial change in circumstances.' The statute specifies that incarceration cannot be treated as voluntary unemployment, so it qualifies as a change. The second and third grounds, in § 451(3)(b), apply unless the parents specifically opted out of them in their agreement: (i) three years have passed since the order was entered, last modified, or adjusted; or (ii) either party's gross income has changed by 15 percent or more since the order was last set. A reduction in income only qualifies if the reduction was involuntary and the parent has made diligent attempts to find comparable work. The court applies the same Child Support Standards Act formula used for the original order — the percentage of combined parental income (17 percent for one child, 25 percent for two, 29 percent for three, 31 percent for four, 35 percent or more for five or more) — but uses current income figures. Under Family Court Act § 451(1), a modification may even be made retroactive (nunc pro tunc) to the date of the initial application based on newly discovered evidence. Procedure: the petition is filed in the NY Family Court in the county where the original order was entered, or where either parent lives. An order that came out of a divorce can be modified in the NY Supreme Court that granted the divorce, or transferred to Family Court by consent. The court schedules a hearing where both sides submit current financial information — pay stubs, tax returns, unemployment documentation, medical bills, the child's current expenses. Support Magistrates handle most Family Court modification cases. If the parent needing help is a Temporary Assistance or Medicaid recipient, the Division of Child Support Services can file the petition as part of the Title IV-D case. Monroe County filings go to Monroe County Family Court. The new order takes effect from the date the petition is filed. The Monroe County Support Collection Unit processes the new amount through any existing wage-withholding order. Legal Aid Society of Rochester and LawNY represent low-income Monroe County parents in modification cases."
  },

  yourRights: {
    en: [
      "A NY parent has the right under Family Court Act § 451 to petition the court for a modification of an existing child support order.",
      "A NY parent has the right under Family Court Act § 451(3)(a) to seek modification based on a substantial change in circumstances — which includes incarceration.",
      "A NY parent has the right under Family Court Act § 451(3)(b) to seek modification when three years have passed since the last order or when either parent's gross income has changed by 15 percent or more, unless the parents specifically opted out of these grounds in their agreement.",
      ...
      "A NY parent has the right under Family Court Act § 440 and § 454 to enforce arrears that accrued before the modification — or to defend against those arrears only on narrow good-cause grounds under Family Court Act § 451(1)."
    ]
  },
  ...
  example: {
    en: "James had a $600 monthly child support order based on a $45,000 annual salary. He was laid off and now receives unemployment benefits of $18,000 per year. He files a petition for modification at Monroe County Family Court under Family Court Act § 451(3)(b)(ii), citing an involuntary reduction in gross income of more than 15 percent. He brings his layoff letter, unemployment-benefit award, and job-search records to show the reduction was involuntary and that he is actively seeking comparable work. The Support Magistrate recalculates using the CSSA formula on his current income. The new monthly order is lower and takes effect from the date James filed the petition. Arrears that accrued before the filing remain owed under Family Court Act § 451(1)."
  },
