export const TENANT_HABITABILITY_NY = {
  ...
  whatItMeans: {
    en: "NY has one of the strongest renter-protection laws in the country. It is called the warranty of habitability — but the word 'warranty' is just a fancy way of saying 'promise.' Every NY landlord makes this promise to every renter, automatically. The lease does not have to mention it. A verbal handshake deal counts too.\n\nThe promise has three parts. First, the place is fit to live in. Second, the place works for the uses both sides agreed on (a one-bedroom should function as a one-bedroom). Third, no conditions in the unit or shared areas put the renter's life, health, or safety in danger.\n\nThe lease cannot take this promise away. Some landlords put a clause in the lease that says the renter gives up these rights. That clause has no legal power. NY law calls it void — meaning the court treats it like it was never written. A landlord also cannot ask the renter to sign a separate paper giving up these rights.\n\nWhat counts as a violation. Courts have ruled the law was broken in cases like: no heat in winter, no hot water, broken plumbing, broken locks that leave the unit unsafe, mice or roach infestations the landlord did not deal with, lead paint hazards in older buildings, mold that hurts health, no electricity, and a ceiling that fell in. Small things like a paint scuff or a sticky drawer do not count. The test is whether the problem affects the renter's health, safety, or basic ability to live there.\n\nHeat rules. From October 1 through May 31, the landlord has to keep the indoor temperature at 68 degrees or higher between 6 a.m. and 10 p.m., and at least 62 degrees overnight, when it is cold outside. Hot water has to be provided year-round, at 120 degrees minimum. NYC has its own version of these rules but the temperatures are the same.\n\nWhat a renter can do when the landlord won't fix the problem. Three options. First, a renter can ask the court for a rent reduction — the court figures out how much the unit was actually worth in its broken state and lowers the rent for that period. Second, a renter can sue for damages. Third, in some cases a renter can pay for the repair and subtract that cost from the next rent payment. This is called repair-and-deduct. Going to court first to get the repair ordered is safer than doing it without that step. To prove the case, photos, a code enforcement inspection report, and the renter's own testimony are usually enough. A renter does not need an expert witness.\n\nNo punishment for asking for repairs. NY law (Real Property Law section 223-b) says a landlord cannot punish a renter for asking for repairs, joining a tenants' group, or reporting the landlord to the city. 'Punishment' means raising the rent, kicking the renter out, or cutting back services like garbage pickup. If the landlord does any of these things within a year of the renter's complaint, the law presumes it was punishment — the burden is on the landlord to prove otherwise. A renter who is being evicted can use this as a defense in court.\n\nReporting to the city. A renter can call the city or town code enforcement office to report a problem. Inside Rochester city limits, that is Neighborhood and Business Development at (585) 428-6520. Outside the city, each Monroe County town has its own building department. The inspector visits the unit and, if they find a violation, gives the landlord a deadline to fix it. If the landlord does not fix it, the city can fine them or order them to make repairs.\n\nMoving out when the place is unsafe. If the unit is so bad it cannot be lived in, NY law (Real Property Law section 227) lets the renter move out, end the lease, and get back any prepaid rent and the security deposit. This is a last resort. The renter has to actually move out and give the landlord written notice.\n\nFree legal help. In Monroe County, tenants who cannot afford a lawyer have three free options: Legal Aid Society of Rochester, LawNY, and the county's right-to-counsel-in-eviction program. A renter can also file an HP (Housing Part) case in Rochester City Court to force the landlord to make repairs. Court filing fees can be waived for tenants with low income."
  },
