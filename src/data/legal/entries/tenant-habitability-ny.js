export const TENANT_HABITABILITY_NY = {
  ...
  anchorSource: {
    ...
    hash: "95b253317d5fa6360127cdecbba602170761a4f2fa5c2595fd684a18a0d5ba2f",
    lastFetched: "2026-05-02"
  },
  lastFormallyReviewed: "2026-05-01",
  formallyReviewedBy: "Anthony DiMarzo + WebSearch + R2–R4 expert review (2026-05-01). Provisional, pending attorney sign-off. Round-by-round detail: src/data/legal/anchor-reviews/tenant-habitability-ny.md.",
  pendingLegislation: ["S5956-2025"],
  sourceChangedSince: "2026-05-02",
  ...
  yourRights: {
    en: [
      ...
      "A NY tenant has the right under NY RPL § 227 to end the lease and stop paying future rent when fire, flood, or similar physical damage (not caused by the tenant) destroys or makes the unit uninhabitable. Prepaid rent gets adjusted. Security deposit return is governed separately by General Obligations Law § 7-108 (interest in 6+ unit buildings is § 7-103).",
  ...
  legalOptions: {
    en: [
      ...
      "NY RPL § 227 — tenant right to end the lease and stop future rent when fire, flood, or similar physical damage (not caused by the tenant) destroys the building. (For security deposit return, see GOL § 7-108.)",
      ...
      "Empire Justice Center at (585) 454-4060 — statewide impact litigation and policy advocacy on housing. Not a frontline direct-representation provider for individual tenants; for direct rep, start with Legal Aid Society of Rochester, LawNY, or JustCause."
    ]
  },
  ...
  counsel: [
    {
      ...
      access: "Phone intake at (585) 232-4090, walk-in at Rochester City Court on court dates. ASL and spoken-language interpreters available on request.",
    ...
    },
    {
      ...
      focus: "Statewide impact litigation and policy advocacy on housing — NOT a frontline direct-representation provider for individual tenants",
      qualifier: "Statewide; impact case selection. For individual eviction or habitability defense in Monroe County, frontline providers are Legal Aid Society of Rochester, LawNY, and JustCause.",
      access: "Voicemail callback at (585) 454-4060",
