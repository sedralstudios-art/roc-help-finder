export const TENANT_HABITABILITY_NY = {
  ...
  whatItMeans: {
    en: "NY has one of the strongest renter-protection laws in the country. It is called the warranty of habitability — but the word 'warranty' is just a fancy way of saying 'promise.' Every NY landlord makes this promise to every renter, automatically. The lease does not have to mention it. A verbal handshake deal counts too.\n\nThe promise has three parts. First, the place is fit to live in. Second, the place works for the uses both sides agreed on (a one-bedroom should function as a one-bedroom). Third, no conditions in the unit or shared areas put the renter's life, health, or safety in danger.\n\nThe lease cannot take this promise away. Some landlords put a clause in the lease that says the renter gives up these rights. That clause has no legal power. NY law calls it void — meaning the court treats it like it was never written. A landlord also cannot ask the renter to sign a separate paper giving up these rights.\n\nWhat counts as a violation. Courts have ruled the law was broken in cases like: no heat in winter, no hot water, broken plumbing, broken locks that leave the unit unsafe, mice, roach, or bedbug infestations the landlord did not deal with, lead paint hazards in older buildings, mold that hurts health, no electricity, and a ceiling that fell in. NY also has a separate disclosure law for bedbugs: under Real Property Law section 235-j, before signing a lease, the landlord has to give the renter a written disclosure of any bedbug history in the building from the past year (on a form prescribed by NY Homes and Community Renewal). Small things like a paint scuff or a sticky drawer do not count. The test is whether the problem affects the renter's health, safety, or basic ability to live there. One important limit: if the renter (or someone in the household, or a guest) caused the condition, it does not count as a breach. The renter is responsible for fixing what they damaged.\n\nHeat rules. Outside New York City — including Rochester and the rest of Monroe County — the rule is set by the Property Maintenance Code of New York State. From September 15 through May 31, the landlord has to keep all habitable rooms, bathrooms, and toilet rooms at 68 degrees or higher, regardless of the outside temperature. Hot water has to be provided year-round at 120 degrees minimum. New York City has a different version of the rule: from October 1 through May 31, 68 degrees during the day (6 a.m. to 10 p.m.) when it is below 55 degrees outside, and 62 degrees overnight regardless of the outside temperature.\n\nWhat a renter can do when the landlord won't fix the problem. There are several options.\n\nFirst, a renter can ask the court for a rent reduction — the court figures out how much the unit was actually worth in its broken state and lowers the rent for that period. The Court of Appeals set this rent-abatement formula in Park West Management Corp. v. Mitchell (1979): damages are the difference between what the apartment would have been worth as promised and what it was actually worth in its broken condition, multiplied by the period the conditions existed.\n\nSecond, a renter can sue for damages directly.\n\nThird — in practice the most-used remedy — a renter can stop paying rent until the landlord fixes the problem. This is risky. The landlord will probably file an eviction case for nonpayment of rent. The renter can then raise the warranty of habitability as a defense and ask the judge for a rent abatement (a partial or full credit against the rent owed). This is the procedure the Court of Appeals endorsed in Park West v. Mitchell. The risk is real: if the judge does not credit the conditions as bad enough, the renter can be ordered to pay the full back rent or face eviction. A renter who tries this should set the unpaid rent aside and document the conditions; talking to a free legal-help org first is strongly recommended.\n\nFourth, in narrow situations a renter may pay for a necessary repair and subtract the cost from the next rent payment. This is called repair-and-deduct. NY does not have a statute that clearly allows it — courts have permitted it only in unusual cases (the canonical example is a landlord who willfully refuses to fix a broken lock). It is risky for the same reason as rent-withholding: if the court later disagrees that the condition was serious enough or the cost was reasonable, the renter can be on the hook for the full rent. Going to court first to get the repair ordered is much safer.\n\nTo prove a habitability case, photos, a code enforcement inspection report, and the renter's own testimony are usually enough. A renter does not need an expert witness.\n\nNo punishment for asking for repairs. NY law (Real Property Law section 223-b) says a landlord cannot punish a renter for asking for repairs, joining a tenants' group, or reporting the landlord to the city. 'Punishment' means things like serving an eviction notice, refusing to renew the lease, or offering a new lease with an unreasonable rent increase. If the landlord does any of these things within a year of the renter's good-faith complaint, the law presumes it was punishment, and the burden is on the landlord to prove otherwise. A renter who is being evicted can use this as a defense in court. One exception: section 223-b does not apply if the landlord lives in the building and the building has fewer than four units.\n\nA separate law (Real Property Law section 235-d) also lets a renter sue when a landlord engages in specific harassing conduct — like cutting off essential services in bad faith, making repeated false reports about the renter to government agencies, or filing repeated frivolous lawsuits. That law allows civil penalties up to $1,000 per violation, plus court orders to stop the harassment.\n\nReporting to the city. A renter can call the city or town code enforcement office to report a problem. Inside Rochester city limits, dial 311 (or 585-428-5990 from a cell phone or from outside the city) and ask for a code enforcement inspection. The general line for Neighborhood and Business Development is 585-428-6883. Outside the city, each Monroe County town has its own building department. The inspector visits the unit and, if they find a violation, gives the landlord a deadline to fix it. If the landlord does not fix it, the city can fine them or order them to make repairs.\n\nMoving out when the building is destroyed or damaged. If the apartment becomes unlivable because of fire, flood, or similar physical damage that is not the renter's fault, NY law (Real Property Law section 227) lets the renter end the lease and stop paying future rent. Any rent paid in advance gets adjusted to the move-out date. This applies to physical destruction of the building — not to general bad conditions like pests or no heat (those go through the warranty of habitability above). Security deposit return is handled separately under General Obligations Law section 7-103. The renter has to actually move out — that is what triggers the end of the rent obligation. Putting the surrender in writing is not required by the statute, but it is strongly recommended so that the surrender date is clear if there is any later dispute about rent owed.\n\nFree legal help. In Monroe County, tenants who cannot afford a lawyer have several free options: Legal Aid Society of Rochester (585-232-4090), LawNY (585-325-2520), JustCause (585-232-3051), and Empire Justice Center (585-454-4060). The Tenant Defense Project of Greater Rochester at 585-504-6195 is a coordinated program that connects tenants facing eviction with attorneys from Legal Aid, LawNY, and JustCause. The Tenant Defense Project is a funded program, not a statutory right to counsel — coverage depends on continued city and county appropriation. A renter can also file a petition in the Rochester City Court housing part — a part of City Court created in 2021 that handles housing code matters — asking the judge to order the landlord to make repairs. A repair petition like this is separate from a rent-reduction lawsuit; the renter may need both to fully address the problem. Court filing fees can be waived for tenants with low income (CPLR section 1101)."
  },
