export const TENANT_HABITABILITY_NY = {
  ...
  formallyReviewedBy: "Anthony DiMarzo + WebSearch corroboration + Round 2 expert review 2026-05-01 (10 issues — 4 errors fixed, 6 clarifications added). ERRORS: heat-rules attribution flipped (state PMCNYS Sept 15-May 31 68° all habitable rooms; NYC has the day/night + 55° trigger version); RPL §227 narrowed to fire/flood physical destruction (was overstated to cover all bad conditions); GOL §7-103 split off for security deposit return; Rochester code phone corrected (585-428-6520 unverified → 311 / 585-428-5990 / 585-428-6883 NBD general); HP-Action framing corrected (Rochester housing part exists since Dec 2021 per Ch. 464 of 2021, but HP is NYC jargon, can't award damages even in NYC). CLARIFICATIONS: repair-and-deduct softened to narrow judge-made remedy (no NY statute); §223-b examples corrected to eviction notice/refusal-to-renew/unreasonable-rent-increase; §223-b owner-occupied <4 unit carve-out added; §235-b tenant-misconduct carve-out added; right-to-counsel renamed to Tenant Defense Project (585-504-6195 added to counsel array); JustCause URL fixed to justcauseny.org. Provisional, pending R3 + attorney sign-off.",
