export const DISABILITY_MEDICAID_NY = {
  ...
  whoQualifies: {
    en: [
      "A NY adult 65 or older under Social Services Law § 366(1)(a) Non-MAGI rules.",
      ...
      "A nursing-home resident or community-based long-term-care recipient seeking Chronic Care Medicaid under Social Services Law § 366 with transfer-of-asset lookback rules.",
  ...
  yourRights: {
    en: [
      ...
      "A NY Non-MAGI applicant has the right under Social Services Law § 366-A to up to three months of retroactive coverage for eligible expenses before the application date.",
      "A NY applicant has the right under Social Services Law § 22 to appeal a denial, reduction, or closure through a fair hearing within 60 days."
    ]
  },
