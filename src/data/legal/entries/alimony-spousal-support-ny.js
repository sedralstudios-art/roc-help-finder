export const ALIMONY_SPOUSAL_SUPPORT_NY = {
  ...
  whatItMeans: {
    en: "New York uses a formula to calculate maintenance during the divorce (called temporary maintenance) and after the divorce (called post-divorce maintenance). The formula is in Domestic Relations Law Section 236. For temporary maintenance where no child support is paid (or the payor receives child support), the court calculates 30% of the higher earner's income minus 20% of the lower earner's income; where child support is paid by the maintenance payor, the formula is 20% of the payor's income minus 25% of the payee's income. The lower of two computations applies. There is an income cap that adjusts every two years for inflation — $241,000 effective March 1, 2026. For post-divorce maintenance, the duration depends on the length of the marriage. For marriages of 0-15 years, maintenance lasts 15% to 30% of the length of the marriage. For 15-20 years, it lasts 30% to 40%. For over 20 years, it lasts 35% to 50%. The court also considers factors like each spouse's age and health, earning ability, whether one spouse gave up career opportunities for the marriage, and whether there are children. Maintenance can be modified if circumstances change significantly — like the paying spouse losing their job or the receiving spouse getting a much higher-paying job. Maintenance is taxed differently from how it used to be. Under the federal Tax Cuts and Jobs Act, for divorces finalized after January 1, 2019, maintenance is no longer deductible by the paying spouse and not taxable income to the receiving spouse — a major shift from the prior decades-long rule. NY has not conformed for state tax purposes, so NY state taxes still treat maintenance as deductible to the payer and taxable to the recipient on the state return. This split has practical effects on how much maintenance the household can support after taxes, and divorce settlements drafted after 2019 typically reflect the lower after-tax burden on the payer by adjusting the gross amount. Lump-sum maintenance buyouts, where the paying spouse pays a single discounted sum instead of monthly maintenance, have become more common since the tax change."
  },
