export const PROPERTY_TAX_GRIEVANCE_NY = {
  ...
  summary: {
    en: "A NY property owner who believes the local assessment is too high can file a formal grievance under Real Property Tax Law Article 5. The grievance is filed on Form RP-524 with the town or city assessor on or before Grievance Day — the fourth Tuesday in May in most NY towns. The Board of Assessment Review (BAR) hears the case. If the BAR denies relief, a residential property owner can file a Small Claims Assessment Review (SCAR) under Real Property Tax Law § 730 within 30 days of the final assessment roll. An Article 7 court case handles commercial or other non-SCAR appeals."
  },
  ...
  yourRights: {
    en: [
      ...
      "A residential property owner has the right under Real Property Tax Law § 730 to Small Claims Assessment Review if the BAR denies the grievance — 30-day filing window after the final assessment roll.",
  ...
  legalOptions: {
    en: [
      ...
      "Small Claims Assessment Review (SCAR) under Real Property Tax Law § 730 for residential property — filed with the Monroe County Clerk within 30 days of the final assessment roll (typically late July). Filing fee is modest; the County Clerk posts the current amount.",
