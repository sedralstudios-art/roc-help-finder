// LGLW6-D_hvac-residential-ny-mon-sweden-town_01.js
...
export const entry = {
  ...
  summary: {
    en: "Town of Sweden does not license HVAC contractors. Gas line work for a new furnace still needs a licensed plumber — the gas pipe is plumbing work. Town staff do HVAC inspections directly (no third-party agencies). The state Energy Code (2025) applies to all permits filed after December 31, 2025."
  },

  whatItMeans: {
    en: "Town of Sweden follows the state Uniform Fire Prevention and Building Code for HVAC work. That includes the Mechanical Code and the Fuel Gas Code. The 2025 Energy Code applies to any permit filed after December 31, 2025 — replacement furnaces, heat pumps, and AC units all have to meet the stricter efficiency rules.\n\nThe town does NOT license HVAC contractors. But gas line work is plumbing. Gas line work needs a qualified plumber with insurance. The town has a separate building sewer connection permit for any sewer work related to the HVAC job (rare).\n\nHVAC permits go through the Building Department. There's no separate third-party agency for HVAC inspection — the town's own inspectors handle it. That's different from electrical, which does use outside agencies.\n\nAnyone handling refrigerant must have federal EPA Section 608 certification.\n\nHomeowner rules: Call the Building Department at (585) 637-8684 to confirm homeowner HVAC rules.\n\nSweden covers the area OUTSIDE Brockport village. Brockport village has its own Building Department. Check which jurisdiction your address falls in."
  },

  example: {
    en: "A homeowner in Town of Sweden replaces an old furnace with a new high-efficiency gas furnace. The HVAC contractor files the mechanical permit with the Building Department. A licensed plumber files a separate plumbing permit for the gas line work. The town's own inspector checks the final install. Because the permit was filed after December 31, 2025, the new unit has to meet the 2025 Energy Code."
  },

  whoQualifies: {
    en: [
      "Property owners and contractors doing HVAC work inside Town of Sweden",
  ...
  legalOptions: {
    en: [
      "Town of Sweden Building Department handles HVAC permits and inspections",
  ...
  counsel: [{
    ...
    qualifier: "Open to residents and contractors working in Town of Sweden",
    access: "Phone",
