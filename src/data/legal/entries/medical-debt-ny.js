...
export const MEDICAL_DEBT_NY = {
  ...
  whoQualifies: {
    en: [
      ...
      "A patient with income below 400% of the federal poverty level under Public Health Law § 2807-k(9-a) — with escalating discount tiers at lower income levels.",
      "A patient at any income level with medical debt appearing on a NY credit report — covered by General Business Law § 380-j's credit-reporting ban.",
  ...
  legalOptions: {
    en: [
      ...
      "NY Department of Health Hospital Financial Assistance page at health.ny.gov/facilities/hospital/financial_assistance — complaint pathway when a hospital fails to comply with Public Health Law § 2807-k.",
      ...
      "NY Attorney General Consumer Frauds Bureau at (800) 771-7755 or ag.ny.gov/consumer-frauds — predatory medical collections and General Business Law § 380-j violations.",
  ...
  example: {
    en: "Amira is uninsured and went to the emergency room at a Monroe County hospital. She received a $6,000 bill. The first bill included the notice of the hospital's financial-assistance program required by Public Health Law § 2807-k. Her household income was about 180% of the federal poverty level. She applied within 90 days. Because she falls below 200% of poverty, the hospital could not charge her more than the Medicaid rate for the services — reducing the bill substantially. The financial-counseling office also screened her for Medicaid. Six months later, when a collector contacted her about the remaining balance, she confirmed the debt was not showing on her credit report — General Business Law § 380-j blocks medical debt from NY credit reports."
  },
