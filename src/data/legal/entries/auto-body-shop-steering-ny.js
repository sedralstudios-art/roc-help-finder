export const AUTO_BODY_SHOP_STEERING_NY = {
  id: "auto-body-shop-steering-ny",
  category: "consumer",
  tier: "state",
  jurisdiction: "us-ny",
  authorityType: "state-statute",
  primaryStatute: "NY INS 2610",
  status: "active",

  title: { en: "NY Auto Body Shop Choice — Insurer Cannot Steer a Driver Away From the Preferred Repair Shop" },

  summary: {
    en: "New York Insurance Law Section 2610 prohibits an auto insurance company from requiring a customer to use a specific repair shop, and from deducting or paying less when the customer picks a non-network shop. Drivers can choose any licensed repair shop in New York for a covered loss. Insurer pressure, delays, or quality claims tied to shop choice are violations of the anti-steering law."
  },

  whoQualifies: {
    en: [
      "Any NY driver whose vehicle needs collision or comprehensive repair after a covered loss.",
      "A driver whose insurance company recommended a specific network shop without explaining the customer's right to choose.",
      "A customer whose preferred shop had a higher estimate and the insurer threatened reduced payment.",
      "A body shop owner whose customer was steered toward a competing shop by the insurer."
    ]
  },
  ...
  example: {
    en: "Sanjay was rear-ended. His insurance company told him he had to use a specific Rochester body shop or the insurer would only pay 85 percent of the estimate. Sanjay preferred his regular mechanic who is a NYS-licensed repair shop. He filed a complaint with NYS Department of Financial Services citing INS 2610. The insurer was contacted by DFS and within ten days agreed to pay the full estimate at Sanjay's preferred shop. The repair took three weeks and the insurer paid directly to the shop with no deduction."
  },
  ...
  counsel: [
    {
      ...
      focus: "Auto insurance anti-steering complaints and claim disputes",
      qualifier: "Any NY auto insurance policyholder or claimant",
      access: "Phone, online complaint portal",
      outcome: "Investigation of anti-steering violations, insurer fines, customer restitution",
      phone: "",
    ...
    {
      type: "government",
      name: "NYS DMV Vehicle Safety Services",
      focus: "Repair shop licensing, complaints against repair shops",
  ...
  tags: [
    ...
    "OEM parts INS 3411",
    "body shop dispute",
    "collision repair choice",
    "non-network shop",
    "auto insurance complaint DFS"
  ],

  sources: [
    "https://www.nysenate.gov/legislation/laws/ISC/2610",
