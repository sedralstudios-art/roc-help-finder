export const COURT_FEE_WAIVER_NY = {
  ...
  title: { en: "Court Fee Waivers in New York — How to File a Case When the Filing Fee Is Too Much" },
  ...
  legalOptions: {
    en: [
      ...
      "In Family Court, there are no filing fees for most petitions — but other courts (Supreme Court, Surrogate's Court) charge filing fees set by the OCA fee schedule that the waiver covers."
    ]
  },
