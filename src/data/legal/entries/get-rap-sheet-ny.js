export const GET_RAP_SHEET_NY = {
  ...
  whoQualifies: {
    en: [
      ...
      "Anyone preparing a Criminal Procedure Law § 160.59 sealing application needs to know what is on their record.",
