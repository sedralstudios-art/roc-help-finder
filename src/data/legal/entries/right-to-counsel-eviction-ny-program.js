export const RIGHT_TO_COUNSEL_EVICTION_NY = {
  ...
  counsel: [
    {
      type: "free",
      name: "Legal Aid Society of Rochester — Right to Counsel",
      focus: "Free eviction defense for income-eligible tenants",
      qualifier: "Income-eligible tenants facing eviction in Monroe County",
      access: "Phone or court appearance",
      outcome: "Full legal representation in eviction proceedings",
      phone: "(585) 232-4090",
