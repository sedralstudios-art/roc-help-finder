export const LANDLORD_RETALIATION_NY = {
  id: "landlord-retaliation-ny",
  category: "housing",
  tier: "state",
  jurisdiction: "us-ny",
  ...
  whoQualifies: {
    en: [
      "Any tenant who has complained to the landlord about conditions in writing or verbally.",
      "Any tenant who has filed a code enforcement or building inspection complaint.",
      "Any tenant who has contacted the health department about conditions in the rental.",
      "Any tenant who has organized with other tenants or joined a tenants' association.",
      "Any tenant who has withheld rent or placed rent in escrow because of unaddressed repair issues."
    ]
  },
  ...
  yourRights: {
    en: [
      ...
      "Keeping written records of complaints (emails, texts, letters, 311 receipts) strengthens the retaliation defense."
    ]
  },

  legalOptions: {
    en: [
      "If retaliation occurs, documenting the timeline is critical — when the complaint was made, when the adverse action happened, and what the landlord said or did.",
      "In an eviction proceeding, the tenant or the tenant's attorney raises retaliation as an affirmative defense. The court must consider it.",
      "A complaint about retaliatory conduct can be filed with code enforcement or reported to the court in a pending eviction case.",
      "Free legal help with landlord retaliation is available through Legal Aid Society of Rochester at (585) 232-4090.",
      "The Rochester Housing Council at (585) 546-3700 provides counseling and mediation for tenant-landlord disputes including retaliation."
    ]
  },
  ...
  counsel: [
    {
      ...
      focus: "Landlord retaliation, eviction defense, tenant rights",
      qualifier: "Low-income residents of Monroe County",
      access: "Phone intake",
      outcome: "Legal representation in eviction proceedings",
      phone: "",
    ...
    },
    {
      ...
      focus: "Tenant-landlord disputes, mediation, housing counseling",
