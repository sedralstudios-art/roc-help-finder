export const AFTER_A_FIRE_NY = {
  ...
  example: {
    en: "A family of four in Rochester loses their apartment to a fire caused by an electrical issue in the building. The Red Cross arrives the same night and sets them up in a hotel for three days with clothing vouchers and food. DSS provides emergency temporary housing assistance the next morning. Legal Aid advises the family that they are not required to pay rent for the destroyed apartment and that the landlord must return the security deposit since the fire was not their fault. Catholic Family Center helps with furniture and household items when the family moves into a new apartment."
  },
