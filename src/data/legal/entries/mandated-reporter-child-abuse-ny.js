export const MANDATED_REPORTER_CHILD_ABUSE_NY = {
  ...
  yourRights: {
    en: [
      "A mandated reporter is legally required to report suspected abuse or maltreatment (Social Services Law § 413).",
      "A mandated reporter making a good-faith report is protected from civil and criminal liability (Social Services Law § 419).",
