export const HVAC_RESIDENTIAL_NY = {
  ...
  formallyReviewedBy: "Anthony DiMarzo + WebSearch corroboration + three rounds of expert review 2026-05-01. R1: NYC exemption, §378/§379 misattribution, RCNYS scope. R2: GBL §349(h) damages structure (Hobish v. AXA 2025); NYSERDA role; Scaffold Law homeowner exemption; §374 Council; 40 CFR Part 82 Subpart F; suspended fossil-fuel ban (Part 1240.6); Amanda's Law CO alarms near-universal; gas-piping locally varying (Putnam example); Nassau/Suffolk small claims $5k. R3: FAIR Business Practices Act past-tense (effective 2026-02-17, now in effect); NYSERDA softened from 'does not write' to 'helps DOS develop' under 2022 Advanced Building Codes Act; fossil-fuel ban mechanism corrected (NY voluntary stipulation in Mulhern Gas Co. v. Mosley, not a court ruling against NY); RCNYS scope expanded to include townhouses up to three stories; electrical inspection mechanism corrected (contractor/homeowner hires inspector, not town); Labor Law §198-e Construction Industry Wage Theft added with apt/commercial scope and home-improvement carve-out; Scaffold Law exception narrowed (scheduling/picking furnace doesn't lose exemption — only HOW the work is run); Lien Law §3 (right) split from §10 (deadlines); UEF named in workers' comp; treble damages plain-rephrased. Provisional, pending attorney sign-off.",
