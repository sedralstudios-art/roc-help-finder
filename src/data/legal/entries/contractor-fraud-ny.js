export const CONTRACTOR_FRAUD_NY = {
  id: "contractor-fraud-ny",
  category: "consumer",
  tier: "state",
  jurisdiction: "us-ny",
  ...
  whoQualifies: {
    en: [
      "Any homeowner or renter who paid a contractor for work that was not completed or was performed so poorly it is essentially useless.",
      "Any person who gave a deposit and the contractor disappeared.",
      "Any person who was charged for materials that were never purchased or work that was never done.",
      "Any person who hired a contractor who turned out to be unlicensed (in a municipality that requires licensing)."
    ]
  },
  ...
  yourRights: {
    en: [
      ...
      "The homeowner can also file a mechanic's lien claim if they paid for materials that were never delivered."
    ]
  },
  ...
  counsel: [
    {
      ...
      focus: "Contractor fraud, home improvement complaints",
