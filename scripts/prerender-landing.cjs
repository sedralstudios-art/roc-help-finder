...
const S = {
  en: {
    ...
    homeLede: 'Food. Housing. Health. Jobs. Crisis support. Legal rights. Hundreds of free programs in 8 languages. No accounts. No personal data collected. Just help.',
